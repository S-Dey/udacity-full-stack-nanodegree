...
foursquare_client_id = "Q0RCMWYRRWULLS1GXY1PA5RBRQPISQ43TGXEV11SWKFVESWO"
foursquare_client_secret = "UQCCUS1FWPSC2DSBU01A5U3NTL0IGXQEAQSJHKNHXOW5XGBB"
...
def findARestaurant(mealType, location):
    ...
    url = ('https://api.foursquare.com/v2/venues/search?client_id=%s&client_secret=%s&v=20180323&ll=%s,%s&query=%s'
           % (foursquare_client_id, foursquare_client_secret, latitude,
              longitude, mealType))
    h = httplib2.Http()
    ...
    if result['response']['venues']:
        ...
        url = ('https://api.foursquare.com/v2/venues/%s/photos?client_id=%s&v=20180323&client_secret=%s'
