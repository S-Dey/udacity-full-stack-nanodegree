...
def fbconnect():
    ...
    access_token_str = request.data.decode("utf-8")
    ...
    redirect_uri = 'https://localhost:5000/restaurant'
    url = "https://graph.facebook.com/v3.0/oauth/access_token?client_id={}&client_secret={}&code='{}'&redirect_uri={}".format(app_id, app_secret, access_token_str, redirect_uri)
    h = httplib2.Http()
